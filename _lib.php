...
function gate_compute_score($ctx = []) {
    ...
    // ---------- Sec-Fetch-* (Chrome/Edge/Firefox modernos los envían siempre) ----------
    // Su ausencia en un UA que se hace pasar por Chrome es señal fuerte de scraper.
    ...
    // ---------- Client Hints en Chrome 100+ (Sec-CH-UA) ----------
    // Falta de Sec-CH-UA en UA que dice ser Chrome >= 100 = sospechoso
...
// =====================================================================
// Per-session asset URL rotation
// Cada visitante recibe un salt aleatorio en cookie _s. Las URLs de
// assets (CSS/JS/IMG) llevan ese salt como querystring. Resultado:
// dos visitas distintas ven URLs diferentes -> rompe fingerprinting
// por URL para clasificadores ML que correlacionan dominios.
// =====================================================================
